    ...
    <>
      {ReactDOM.createPortal(
        <>
          ...
          />
          <div className="fixed w-3/4 top-1/2 left-1/2 bg-white rounded-lg flex flex-col justify-center -translate-x-1/2 -translate-y-1/2 font-poppins px-6 md:px-12 py-6 z-50 lg:w-max">
            ...
            <div className="ml-auto mt-8 ">
              <span
                className="text-black font-medium mr-7 md:mr-10 text-xs sm:text-sm md:text-base lg:mr-14 cursor-pointer active:text-gray"
